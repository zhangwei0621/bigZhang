package com.study.googletranslatedemo.develop.filtermask
...
import com.study.googletranslatedemo.databinding.ActivityFilterMaskBinding
 ...
 * 这里测试形状遮罩+滤镜的效果
 */
class FilterMaskActivity : BaseAct<ActivityFilterMaskBinding>() {
    ...
    override fun getViewBinding() = ActivityFilterMaskBinding.inflate(layoutInflater)
    ...
    override fun initView() {
        ...
        binding.btnExport.setOnClickListener {
            ...
            FileUtils.saveBitmap(this, "filer_mask", bitmap)
